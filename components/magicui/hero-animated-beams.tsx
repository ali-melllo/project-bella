...
import { Badge, CreditCardIcon, Inbox, MapIcon, PlaneTakeoffIcon } from "lucide-react";
...
>(({ className, children, href }, ref) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex size-12 items-center justify-center rounded-3xl border-2  bg-background [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
                className,
            )}
        >
...
export function HeroAnimatedBeam() {
    ...
    return (
        <div
            className="relative flex min-h-[450px] md:max-h-[500px] w-full items-center justify-center"
            ref={containerRef}
        >
